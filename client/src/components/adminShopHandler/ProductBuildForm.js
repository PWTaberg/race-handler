...
const ProductBuildForm = () => {
    ...
    const { addProduct, updateProduct, clearCurrentProduct, currentProduct } = shopHandlerContext;
    ...
    return (
        <form onSubmit={onSubmit}>
            <div className='form-group'>
                <h2 className='text-primary'>{currentProduct ? 'Edit Product' : 'Add Product'}</h2>
                <input
                    type='text'
                    placeholder='Name'
                    name='name'
                ...
                <div>
                    <input
                        type='submit'
                        value={currentProduct ? 'Update Product' : 'Add Product'}
